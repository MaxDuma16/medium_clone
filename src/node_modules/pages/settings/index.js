...
import BackendErrorMessages from 'components/BackendErrorMassages';
import useLocalSrorage from 'hooks/useLogalStorage';
...
const Settings = () => {
    ...
    const [, setToken] = useLocalSrorage('token');
            ...
            <div className='container page'>
                <div className='row'>
                    <div className='col-md-6 offset-md-3 col-sx-12'>
                        <h1 className='text-sx-center'>Your settings</h1>
